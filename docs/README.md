...
Working documents behind the chrossides.com rebuild. Everything here is internal — none of it is published by the site build.
...
| **[PHOTO-BRIEF.md](PHOTO-BRIEF.md)** | What to shoot and how, in priority order. Photographs are the only outstanding ask left on the project |
...
**If you only do a few things**, the ordered priority list is in [SOCIAL.md](SOCIAL.md) under "Read this first": reviews, Google profile photos, the five product questions in [RANKING-PLAN.md](RANKING-PLAN.md), then everything else.
