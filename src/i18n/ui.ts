  ...
  el: {
    ...
    products: {
      ...
      categories: [
        ...
        { title: 'Στρατιωτικά είδη', sub: 'Military supplies', desc: 'Πηλήκια, μπερέδες, εξοπλισμός.' },
      ],
  ...
  en: {
    ...
    products: {
      ...
      categories: [
        ...
        { title: 'Military supplies', sub: 'Στρατιωτικά είδη', desc: 'Kepis, berets, field equipment.' },
      ],
